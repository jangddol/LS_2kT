#include "LS_2kTDetectorConstruction.hh"
...
constexpr double R_noUnit = 7.8161;


LS_2kTDetectorConstruction::LS_2kTDetectorConstruction() : G4VUserDetectorConstruction() {}


LS_2kTDetectorConstruction::~LS_2kTDetectorConstruction() {}


G4VPhysicalVolume* LS_2kTDetectorConstruction::Construct()
{
...
// Shape
	G4double shape_sizeR = R_noUnit*m
